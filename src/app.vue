<template>
    <div id="app">
        <!--<p style='text-align:center;'>给最爱的小宝贝儿写的例子</p>
        <input v-model="val" style="width:300px;"></input><br/>
        我刚刚输入的是：{{val}} <br/>
        是的，我输入的的确是：<input v-model="val" style="width:300px;"></input><br/>
        <input v-model="val2" style="width:500px;"></input>
        <p>*************************************************我是华丽的分割线*******************************************</p>-->      
        <div style="border-bottom: 1px solid #000;text-align: leftnpm ru">
...
<script>
    ...
    export default {
        ...
        computed: {
            val2(){
                return '首先我申明我家小宝贝最可爱，其次，你刚刚输入的倒过来是:'+this.reverse(this.val);
            },
            // curImg(){
            //     if(this.cur==='auto'){
            //         return 'auto';
